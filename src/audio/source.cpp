...
namespace siege
{
	namespace audio
	{
		void Source::create(float priority, float volume, float pitch, bool looping)
		{
		...
		{
			create(priority, volume, pitch, looping);
		}
		Source::Source(float priority, float volume, float pitch)
		{
			create(priority, volume, pitch, false);
		}
		Source::Source(float priority, float volume, bool looping)
		{
			create(priority, volume, 1.0, looping);
		}
		Source::Source(float priority, float volume)
		{
			create(priority, volume, 1.0, false);
		}
		Source::Source(float priority, bool looping)
		{
			create(priority, 1.0, 1.0, looping);
		}
		Source::Source(float priority)
		{
			create(priority, 1.0, 1.0, false);
		}
		Source::Source(bool looping)
		{
			create(0.0, 1.0, 1.0, looping);
		}
		Source::Source()
		{
			create(0.0, 1.0, 1.0, false);
		}
		Source::~Source()
		{
